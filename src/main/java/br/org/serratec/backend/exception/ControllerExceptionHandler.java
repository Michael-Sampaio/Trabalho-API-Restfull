...
public class ControllerExceptionHandler {
    ...
    /**
     * Metodo responsável para tratar qualquer exception do tipo ResourceBadRequestException em todo o projeto.
     * @param exception Exception criada para trabalhar com erros por parte do cliente.
    ...
    public ResponseEntity<?> handlerResourceNotFoundException(RecursoNotFoundException notFoundException){
        ...
        RespostaErro erro = new RespostaErro(
            ...
            notFoundException.getClass().getName(),
            dataHoraAtual);
